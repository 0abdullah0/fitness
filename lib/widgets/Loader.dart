...
class ColorLoader extends StatefulWidget {
  ...
  ColorLoader({
    this.dotOneColor =  Colors.orange,
    this.dotTwoColor = Colors.blue,
    this.dotThreeColor = Colors.grey,
  ...
  @override
  __ColorLoaderState createState() => __ColorLoaderState();
}

class __ColorLoaderState extends State<ColorLoader>
